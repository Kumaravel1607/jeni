...
class VariantEdit extends StatefulWidget {
  String id = "";
  String Name = "";
  String ShortName = "";
  VariantEdit({required this.id, required this.Name, required this.ShortName});

  @override
  _VariantEditState createState() => _VariantEditState();
}

class _VariantEditState extends State<VariantEdit> {
  bool _loading = false;
  ...
  void initState() {
    ...
    super.initState();
    setState(() {
      VariantName.text = widget.Name;
      ShortName.text = widget.ShortName;
    });
  }
  ...
  //---------------------------API--------------------------------//
  updateVariant() {
    Service.EditVariants(VariantName.text, ShortName.text, widget.id)
        .then((result) {
      setState(() {
        _loading = false;
